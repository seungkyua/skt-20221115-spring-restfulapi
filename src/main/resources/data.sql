...
insert into users(join_date, name, password, ssn) values(now(), 'User3-1', 'test333', '901212-3333333');
insert into users(join_date, name, password, ssn) values(now(), 'User4', 'test444', '901212-4444444');
